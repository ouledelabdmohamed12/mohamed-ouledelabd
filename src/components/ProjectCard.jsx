...
const ProjectCard = ({project, index, isDarkMode}) => {
  ...
  return <motion.div
    ...
    >
        <div className={`h-full flex flex-col rounded-2xl overflow-hidden border transition-all duration-500 ${
            isDarkMode 
        ...
        >
            ...
            <div className="relative overflow-hidden">
                ...
                <motion.div
                    ...
                    className="pointer-events-none group-hover:pointer-events-auto absolute inset-0 bg-black/60 backdrop:-blur-sm flex items-center justify-center space-x-4"  
                >
                    <motion.a
